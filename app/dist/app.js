...
},{"../adapters/http":2,"../adapters/xhr":2,"_process":78}],6:[function(require,module,exports){
'use strict';
...
},{"buffer":74}],24:[function(require,module,exports){
'use strict';
...
},{"_process":78,"fbjs/lib/invariant":42}],42:[function(require,module,exports){
(function (process){
/**
...
},{"_process":78}],43:[function(require,module,exports){
/**
...
require('./stores/document');

require('./stores/import');

_coreApplication2['default'].start();

},{"./core/application":64,"./core/constants":65,"./core/dispatcher":66,"./stores/auth":71,"./stores/document":72,"./stores/import":73}],51:[function(require,module,exports){
'use strict';
...
exports['default'] = {
  render: function render() {
    return (0, _virtualElement2['default'])(
      ...
      (0, _virtualElement2['default'])(_chat2['default'], null),
...
},{"./chat":52,"./doc-editor":53,"./doc-list":54,"./doc-toolbar":55,"./import":59,"virtual-element":46}],52:[function(require,module,exports){
'use strict';
...
var Chat = {
  ...
  render: function render(_ref, setState) {
    ...
    var sendChat = function sendChat(e, component, setState) {
      e.preventDefault();
      alert('Chat Send');
      return false;
    };
    ...
    try {
      for (var _iterator = chats[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        messages.push((0, _virtualElement2['default'])(
          'a',
          { 'class': 'item' },
          chat.name
        ));
    ...
    var create = function create() {
      return _coreDispatcher2['default'].dispatchAction(ACTIONS.CREATE_DOCUMENT);
    };

    return (0, _virtualElement2['default'])(
      'div',
      { id: 'chat', 'class': 'ui left fixed vertical menu' },
      (0, _virtualElement2['default'])(
        'div',
        { 'class': 'ui horizontal divider' },
        'Chat'
      ),
      messages.length != 0 ? messages : (0, _virtualElement2['default'])(
        'a',
        { 'class': 'item', onClick: create },
        'Start the conversation.'
      ),
      (0, _virtualElement2['default'])(
        'form',
        { id: 'chat-form', onSubmit: sendChat },
        (0, _virtualElement2['default'])('input', { type: 'text', placeholder: 'what do you want to say?', 'class': 'input text', on: true })
      )
    );
  }
};
...
},{"../core/dispatcher":66,"virtual-element":46}],53:[function(require,module,exports){
'use strict';
...
var DocumentEditor = {
  ...
  afterUpdate: function afterUpdate(component, prevProps, prevState, setState) {
    ...
    setState({
      offSave: _coreDispatcher2['default'].onAction(ACTIONS.SAVE_DOCUMENT, function callee$1$0() {
        var body, documentId;
    ...
    return regeneratorRuntime.async(function afterMount$(context$1$0) {
      ...
      while (1) switch (context$1$0.prev = context$1$0.next) {
        case 0:
          ...
          _coreDispatcher2['default'].onAction(ACTIONS.FULLSCREEN_DOCUMENT, function () {
            return editor.enterFullscreen();
          });
          _coreDispatcher2['default'].onAction(ACTIONS.PREVIEW_DOCUMENT, function () {
...
},{"../core/dispatcher":66,"../stores/document":72,"lodash.debounce":43,"virtual-element":46}],54:[function(require,module,exports){
'use strict';
...
exports['default'] = {
  ...
  render: function render(_ref2, setState) {
    ...
    function selectItem(id) {
      return function () {
        return _coreDispatcher2['default'].dispatchAction(ACTIONS.SET_ROUTE, { route: '/doc/' + id });
      };
    }
    ...
    try {
      for (var _iterator = documents[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        // }
        list.push((0, _virtualElement2['default'])(
          'div',
          { 'class': 'ui card', onClick: selectItem(item.id) },
          (0, _virtualElement2['default'])(
            'div',
            { 'class': 'content' },
            (0, _virtualElement2['default'])(
    ...
    return (0, _virtualElement2['default'])(
      'div',
      { id: 'document-list', 'class': 'ui cards' },
      (0, _virtualElement2['default'])(
        Loader,
        { active: state.loading },
        'Loading'
      ),
      list.length != 0 ? list : (0, _virtualElement2['default'])(
        'a',
        { 'class': 'item', onClick: create },
        'Create a document.'
      )
...
},{"../core/dispatcher":66,"../stores/document":72,"virtual-element":46}],55:[function(require,module,exports){
'use strict';
...
var Toolbar = {
  ...
  afterMount: function afterMount(component, el, setState) {
    ...
    _coreDispatcher2['default'].onAction(ACTIONS.EDIT_DOCUMENT, function () {
      setState({
        preview: false
      });
    });
  ...
  render: function render(component) {
    ...
    var removeDocument = function removeDocument() {
      return _coreDispatcher2['default'].dispatchAction(ACTIONS.REMOVE_DOCUMENT);
    };
    var saveDocument = function saveDocument() {
      return _coreDispatcher2['default'].dispatchAction(ACTIONS.SAVE_DOCUMENT);
    };
    var previewDocument = function previewDocument() {
      return _coreDispatcher2['default'].dispatchAction(ACTIONS.PREVIEW_DOCUMENT);
    };
    var editDocument = function editDocument() {
      return _coreDispatcher2['default'].dispatchAction(ACTIONS.EDIT_DOCUMENT);
    };
    var fullScreenDocument = function fullScreenDocument() {
      return _coreDispatcher2['default'].dispatchAction(ACTIONS.FULLSCREEN_DOCUMENT);
    };
    ...
    return (0, _virtualElement2['default'])(
      ...
      !state.preview ? (0, _virtualElement2['default'])(
        'button',
        { 'class': 'ui button', onClick: previewDocument },
        (0, _virtualElement2['default'])('i', { 'class': 'unhide icon' })
      ) : (0, _virtualElement2['default'])(
        'button',
        { 'class': 'ui button', onClick: editDocument },
      ...
      (0, _virtualElement2['default'])(
        ...
        (0, _virtualElement2['default'])(_dropdown2['default'], { name: 'Settings', items: [{ name: "Import", icon: "import", description: "Import documents", onClick: function onClick() {
              return _coreDispatcher2['default'].dispatch({ actionType: ACTIONS.OPEN_IMPORT });
            } }, { name: "Logout", icon: "sign out", description: "Go back to login", onClick: function onClick() {
              return _coreDispatcher2['default'].dispatch({ actionType: ACTIONS.SET_ROUTE, route: '/logout' });
            } }] })
      )
    );
  }
...
},{"../core/dispatcher":66,"./dropdown":57,"virtual-element":46}],56:[function(require,module,exports){
'use strict';
...
},{"./chat":52,"./doc-editor":53,"./doc-list":54,"./doc-toolbar":55,"./import":59,"virtual-element":46}],57:[function(require,module,exports){
'use strict';
...
},{"../core/dispatcher":66,"virtual-element":46}],58:[function(require,module,exports){
"use strict";
...
},{"virtual-element":46}],59:[function(require,module,exports){
'use strict';
...
var Dropdown = {
  ...
  afterMount: function afterMount(component, el, setState) {
    _coreDispatcher2['default'].onAction(ACTIONS.OPEN_IMPORT, function () {
  ...
  render: function render(component) {
    ...
    var submit = function submit() {
      _coreDispatcher2['default'].dispatchAction(ACTIONS.IMPORT_URL, { url: state.url });
    };
...
},{"../core/dispatcher":66,"virtual-element":46}],60:[function(require,module,exports){
'use strict';
...
var Layout = {
  ...
  afterMount: function afterMount(c, el, update) {
    _coreDispatcher2['default'].onAction(ACTIONS.SET_VIEW, function (data) {
      return update({ 'view': data.view, props: data });
    });
  },
  render: function render(c) {
    ...
    return (0, _virtualElement2['default'])(
      ...
      (0, _virtualElement2['default'])(View, c.state.props)
    );
  }
};
...
},{"../core/dispatcher":66,"./app-view":51,"./forkme":58,"deku":16,"virtual-element":46}],61:[function(require,module,exports){
'use strict';
...
},{"../core/dispatcher":66,"../stores/auth":71,"virtual-element":46}],62:[function(require,module,exports){
'use strict';
...
},{"../core/dispatcher":66,"../stores/auth":71,"virtual-element":46}],63:[function(require,module,exports){
'use strict';
...
},{"flux":40}],64:[function(require,module,exports){
'use strict';
...
var _componentsDocView = require('../components/doc-view');

var _componentsDocView2 = _interopRequireDefault(_componentsDocView);
...
var Application = (function () {
  function Application() {
    ...
    _dispatcher2['default'].onAction(ACTIONS.SET_ROUTE, function (data) {
  ...
  _createClass(Application, [{
    ...
    value: function unauthed() {
      if (_storesAuth2['default'].isAuthenticated()) {
        _dispatcher2['default'].dispatchAction(ACTIONS.LOGOUT, {});
      }
    }
  }, {
    key: 'app',
    value: function app() {
      _dispatcher2['default'].dispatchAction(ACTIONS.SYNC_DOCUMENTS, {});
      _dispatcher2['default'].dispatchAction(ACTIONS.SET_VIEW, {
    ...
    value: function document(id) {
      _dispatcher2['default'].dispatchAction(ACTIONS.SET_VIEW, {
        view: _componentsDocView2['default'],
        documentId: id
      });
    }
  }, {
...
},{"../components/app-view":51,"../components/doc-view":56,"../components/layout":60,"../components/login-view":61,"../components/register-view":62,"../stores/auth":71,"./dispatcher":66,"director":39}],65:[function(require,module,exports){
'use strict';
...
},{"./action-dispatcher":63}],67:[function(require,module,exports){
'use strict';
...
},{"../stores/auth":71,"./constants":65,"./errors":67,"axios":1,"object-assign":45}],69:[function(require,module,exports){
'use strict';
...
},{"../core/action-dispatcher":63,"object-assign":45}],70:[function(require,module,exports){
'use strict';
...
var _templateObject = _taggedTemplateLiteral(['/auth/login'], ['/auth/login']),
    ...
    _templateObject3 = _taggedTemplateLiteral(['/api/documents'], ['/api/documents']),
    _templateObject4 = _taggedTemplateLiteral(['/api/importurl'], ['/api/importurl']);
...
exports['default'] = {
  ...
  syncDocuments: _coreHttp2['default'].get(_templateObject3),
  fetchDocument: function fetchDocument(id) {
  ...
  updateDocument: function updateDocument(id, data) {
  ...
  importUrl: function importUrl(data) {
    return _coreHttp2['default'].post(_templateObject4)(data);
  }
};
module.exports = exports['default'];

},{"../core/http":68}],71:[function(require,module,exports){
/**
 * AuthStore
...
var AuthStore = (function (_Store) {
  ...
  function AuthStore() {
    ...
    _coreDispatcher2['default'].onAction(ACTIONS.LOGIN, function (data) {
      return _this.loginAction(data);
    });
    _coreDispatcher2['default'].onAction(ACTIONS.REGISTER, function (data) {
      return _this.registerAction(data);
    });
    _coreDispatcher2['default'].onAction(ACTIONS.LOGOUT, function () {
      ...
      return regeneratorRuntime.async(function loginAction$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            console.log(data);
            context$2$0.next = 4;
            return regeneratorRuntime.awrap(_httpApi2['default'].login(data));
      ...
      return regeneratorRuntime.async(function registerAction$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            console.log(data);
            context$2$0.next = 4;
            return regeneratorRuntime.awrap(_httpApi2['default'].register(data));
...
},{"../core/constants":65,"../core/dispatcher":66,"../core/errors":67,"../core/store":69,"../http/api":70}],72:[function(require,module,exports){
/**
 * AuthStore
 * a store that uses api calls and local storage to manage token based user authentication
 *
...
var DocumentStore = (function (_Store) {
  ...
  function DocumentStore() {
    ...
    _coreDispatcher2['default'].onAction(ACTIONS.SYNC_DOCUMENTS, function () {
      return _this.sync();
    });
    _coreDispatcher2['default'].onAction(ACTIONS.SELECT_DOCUMENT, function (data) {
      return _this.select(data);
    });
    _coreDispatcher2['default'].onAction(ACTIONS.CREATE_DOCUMENT, function () {
      return _this.create();
    });
    _coreDispatcher2['default'].onAction(ACTIONS.REMOVE_DOCUMENT, function () {
      return _this.remove();
    });
  }
      ...
      return regeneratorRuntime.async(function create$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            context$2$0.prev = 0;
            context$2$0.next = 3;
            return regeneratorRuntime.awrap(_httpApi2['default'].createDocument({
              body: "# Untitled"
            }));
      ...
      return regeneratorRuntime.async(function remove$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            context$2$0.prev = 0;
            context$2$0.next = 3;
            return regeneratorRuntime.awrap(_httpApi2['default'].deleteDocument(this.getState().selected.id));
      ...
      return regeneratorRuntime.async(function sync$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            context$2$0.prev = 0;
            context$2$0.next = 3;
            return regeneratorRuntime.awrap(_httpApi2['default'].syncDocuments());
      ...
      return regeneratorRuntime.async(function select$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            context$2$0.prev = 0;
            context$2$0.next = 3;
            return regeneratorRuntime.awrap(_httpApi2['default'].fetchDocument(id));
      ...
      return regeneratorRuntime.async(function save$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            context$2$0.prev = 0;
            context$2$0.next = 3;
            return regeneratorRuntime.awrap(_httpApi2['default'].updateDocuments(id, data));
...
},{"../core/dispatcher":66,"../core/store":69,"../http/api":70}],73:[function(require,module,exports){
/**
 * AuthStore
 * a store that uses api calls and local storage to manage token based user authentication
 *
...
var ImportStore = (function (_Store) {
  _inherits(ImportStore, _Store);
  ...
  function ImportStore() {
    ...
    _get(Object.getPrototypeOf(ImportStore.prototype), 'constructor', this).call(this);
    _coreDispatcher2['default'].onAction(ACTIONS.IMPORT_URL, function (data) {
      return _this.importUrl(data);
    });
  }

  _createClass(ImportStore, [{
    key: 'importUrl',
    value: function importUrl(_ref) {
      var url = _ref.url;

      var _ref2, data;

      return regeneratorRuntime.async(function importUrl$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            context$2$0.prev = 0;
            context$2$0.next = 3;
            return regeneratorRuntime.awrap(_httpApi2['default'].importUrl({ url: url }));

          case 3:
            _ref2 = context$2$0.sent;
            data = _ref2.data;
            context$2$0.next = 7;
            return regeneratorRuntime.awrap(_httpApi2['default'].createDocument({ body: data.body }));
...
exports['default'] = new ImportStore();
module.exports = exports['default'];

},{"../core/dispatcher":66,"../core/store":69,"../http/api":70}],74:[function(require,module,exports){
(function (global){
/*!
