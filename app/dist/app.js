...
exports['default'] = {
  render: function render() {
    return (0, _virtualElement2['default'])(
      'div',
      { 'class': 'ui container' },
      (0, _virtualElement2['default'])(Toolbar, null),
